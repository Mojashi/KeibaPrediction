...
query = features.make_query() + " where re1.race_id between 39000 and 40000 order by re1.race_id"
print(query)
...
encoded = features.cleaning(encoded, lambdarank=True,rid=False)
