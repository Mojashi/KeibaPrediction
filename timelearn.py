...
query = features.make_query() + " where re1.race_id between 10000 and 40000"
print(query)
...
encoded = features.cleaning(encoded, multi=True)
...
pickle.dump(model, open("models/reg.lgb","wb"))
print(pre)
