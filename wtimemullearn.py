...
query = features.make_query() + " where re1.race_id between 10000 and 40000 order by re1.race_id"
print(query)
...
encoded = features.cleaning(encoded, multi=True, rid=False)
...
pickle.dump(model, open("models/wtimemultitop.lgb","wb"))
print(pre)
